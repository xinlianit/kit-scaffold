...
const (
	...
	CodeErrorRequestProtocol  scaffold.EnumType = 1008 // CodeErrorRequestProtocol 1008-请求协议错误
	CodeErrorResponseProtocol scaffold.EnumType = 1009 // CodeErrorResponseProtocol 1009-响应协议错误
)
...
func init() {
	...
	scaffold.EnumName[CodeErrorRequestProtocol] = "请求协议错误"
	scaffold.EnumName[CodeErrorResponseProtocol] = "响应协议错误"
}
